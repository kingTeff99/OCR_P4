...
public class FareCalculatorServiceTest {
    ...
    @Test
    public void calculateFareCarWithLessOrEgalToThirtyMinutesParkingTime(){
        Date inTime = new Date();
    ...
    @Test
    public void calculateFareBikeWithLessOrEgalToThirtyMinutesParkingTime(){
        Date inTime = new Date();
        inTime.setTime( System.currentTimeMillis() - (	30 * 60 * 1000));//30 minutes parking time or less should give FREE parking fare
        Date outTime = new Date();
        ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.BIKE,false);
    ...
    @Test
    public void calculateFareFor5PercentDiscountForACarWith3HoursParkingTime(){
    	Date inTime = new Date();
    ...
    @Test
    public void calculateFareFor5PercentDiscountForABikerWith2HoursParkingTime(){
    	Date inTime = new Date();
        ...
        fareCalculatorService.calculateFare(ticket);
//      assertThrows(NullPointerException.class, () -> fareCalculatorService.calculateFare(ticket));
        assertEquals((2.0 * Fare.DISCOUNT_FOR_RECURRENT_USER * Fare.BIKE_RATE_PER_HOUR), ticket.getPrice() );	
